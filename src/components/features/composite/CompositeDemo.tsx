...
export const CompositeDemo = () => {
    const [size, setSize] = useState<{ [key: string]: number }>({ root: 0, f1: 10, f2: 20 });
    ...
    return (
        <DemoShell title="File System Composite" description="The Root folder calculates total size by asking its children, recursively.">
            <div className="relative h-[500px] flex flex-col">
                <SvgCanvas className="flex-1">
                    ...
                    <Node id="file1" type="target" {...nodes.file1} onClick={() => setSize(s => ({ ...s, f1: s.f1 + 5 }))} />
                    <Node id="file2" type="target" {...nodes.file2} onClick={() => setSize(s => ({ ...s, f2: s.f2 + 5 }))} />
