        ...
        <SvgCanvas className="flex-1">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-4">
            <div className="flex gap-2">
              {["A", "B", "C"].map((char) => (
                <button
                  ...
                  className="w-12 h-12 rounded bg-slate-900 text-white font-bold shadow hover:scale-105 transition-transform"
                >
                  {char}
                </button>
              ))}
            ...
            <button
              ...
              className="px-4 py-2 bg-yellow-500 text-white rounded font-bold disabled:opacity-50"
            >
              Undo
            </button>
            <button
              ...
              className="px-4 py-2 bg-green-500 text-white rounded font-bold disabled:opacity-50"
            >
              Redo
            </button>
          </div>
