...
export const SvgCanvas: React.FC<SvgCanvasProps> = ({
    ...
    return (
        <div
            ref={containerRef}
            className={clsx("relative w-full h-[600px] overflow-hidden bg-slate-50 border rounded-xl shadow-inner select-none cursor-grab active:cursor-grabbing", className)}
