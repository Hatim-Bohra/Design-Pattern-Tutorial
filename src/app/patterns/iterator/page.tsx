...
export const metadata: Metadata = { title: "Iterator Pattern", description: "Learn the Iterator Pattern." };
    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-12 space-y-16">
            ...
            <section className="space-y-4">
                ...
                <CodeTabs tabs={[{ id: "ts", label: "Example", language: "typescript", code: `interface Iterator<T> { hasNext(): boolean; next(): T; }` }]} />
            </section>
        </div>
    );
}
