...
export const metadata: Metadata = { title: "Bridge Pattern", description: "Learn the Bridge Pattern." };
    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-12 space-y-16">
            ...
            <section className="space-y-4">
                ...
                <CodeTabs tabs={[{ id: "ts", label: "Example", language: "typescript", code: `class Remote { constructor(private device: Device) {} togglePower() { this.device.enable(); } }` }]} />
            </section>
        </div>
    );
}
