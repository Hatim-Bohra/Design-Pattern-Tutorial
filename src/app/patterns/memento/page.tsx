...
export const metadata: Metadata = { title: "Memento Pattern", description: "Learn the Memento Pattern." };
    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-12 space-y-16">
            ...
            <section className="space-y-4">
                ...
                <CodeTabs tabs={[{ id: "ts", label: "Example", language: "typescript", code: `class Memento { constructor(private state: State) {} getState() { return this.state; } }` }]} />
            </section>
        </div>
    );
}
